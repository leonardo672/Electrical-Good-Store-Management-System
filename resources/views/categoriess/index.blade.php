...
<div class="card shadow-lg rounded card-bg">
    ...
    <div class="card-body">
        ...
        <a href="{{ url('/categoriess/create') }}" class="btn btn-add-user mb-3" title="Add New Category">
                ...
                <tbody>
                    @foreach($categoriess as $item)
                        <tr>
                            ...
                            <td>
                                <!-- View Button -->
                                <a href="{{ url('/categoriess/' . $item->id) }}" title="View Category">
                                ...
                                <!-- Edit Button -->
                                <a href="{{ url('/categoriess/' . $item->id . '/edit') }}" title="Edit Category">
                                ...
                                <!-- Delete Button -->
                                <form method="POST" action="{{ url('/categoriess/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
