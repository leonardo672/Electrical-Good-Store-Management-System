...
<div class="card-body">
    ...
    <a href="<?php echo e(url('/categories/create')); ?>" class="btn btn-saddle-brown btn-lg mb-3" title="Add New Category">
            ...
            <tbody>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <!-- View Button -->
                            <a href="<?php echo e(url('/categories/' . $item->id)); ?>" title="View Category">
                            ...
                            <!-- Edit Button -->
                            <a href="<?php echo e(url('/categories/' . $item->id . '/edit')); ?>" title="Edit Category">
                            ...
                            <form method="POST" action="<?php echo e(url('/categories/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\Projects\Hasanin\Electrical_Goods_Store-app\resources\views/categories/index.blade.php ENDPATH**/ ?>