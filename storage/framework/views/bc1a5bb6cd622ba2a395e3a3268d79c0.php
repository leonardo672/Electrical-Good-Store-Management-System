...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?php echo e(url('/users')); ?>" class="button-hover-effect"><i class="fas fa-users"></i> Users</a>
        <a href="<?php echo e(url('/customers')); ?>" class="button-hover-effect"><i class="fas fa-user-friends"></i> Customers</a>

        <!-- Product Management Section -->
        <h5>Product Management</h5>
        <a href="<?php echo e(url('/categoriess')); ?>" class="button-hover-effect"><i class="fas fa-cogs"></i> Categories</a>
        <a href="<?php echo e(url('/brands')); ?>" class="button-hover-effect"><i class="fas fa-tag"></i> Brands</a>
        <a href="<?php echo e(url('/products')); ?>" class="button-hover-effect"><i class="fas fa-box"></i> Products</a>

        <!-- Order Management Section -->
        <h5>Order Management</h5>
        <a href="<?php echo e(url('/orders')); ?>" class="button-hover-effect"><i class="fas fa-shopping-cart"></i> Orders</a>
        <a href="<?php echo e(url('/order_items')); ?>" class="button-hover-effect"><i class="fas fa-box-open"></i> Order Items</a>
        <a href="<?php echo e(url('/stock_movements')); ?>" class="button-hover-effect"><i class="fas fa-truck"></i> Stock Movements</a>
    </div>
...
<?php /**PATH D:\laravel\Projects\Hasanin\Electrical_Goods_Store-app\resources\views/layout.blade.php ENDPATH**/ ?>