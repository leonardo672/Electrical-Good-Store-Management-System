...
<div class="card shadow-lg rounded card-bg">
    ...
    <div class="card-body">
        ...
        <a href="<?php echo e(url('/users/create')); ?>" class="btn btn-add-user btn-lg mb-3" title="Add New User">
                ...
                <tbody>
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-uppercase"><?php echo e($item->role); ?></td>
                            <td>
                                <!-- View Button -->
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\Projects\Hasanin\Electrical_Goods_Store-app\resources\views/users/index.blade.php ENDPATH**/ ?>